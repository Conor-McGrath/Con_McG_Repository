...
<<<<<<< HEAD
Since we are rolling up on the spookiest holiday, it is definitely worth pulling in some data on horror movies. Not surprisingly, Wikipedia has some information about the top-grossing horror movies of all time.
=======
